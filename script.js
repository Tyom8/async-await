class Clock {
 ...
 async setAlert (_hour,_minute,_second) {
...
clock.start();
clock.setAlert(21,50,00).then(() => {
    console.log(`Gnal gorci`);
});
clock.setAlert(21,50,00).then(function () {
    console.log(`Ush e`);
});
clock.setAlert(21,50,03).then(function () {
    console.log(`tick`);
});
